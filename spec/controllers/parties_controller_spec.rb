  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved party as @party" do
        ...
        post :create, {:party => { "title" => "invalid value" }}, valid_session
        assigns(:party).should be_a_new(Party)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested party" do
        ...
        Party.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => party.to_param, :party => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the party as @party" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Party.any_instance.stub(:save).and_return(false)
        put :update, {:id => party.to_param, :party => { "title" => "invalid value" }}, valid_session
        assigns(:party).should eq(party)
      end
